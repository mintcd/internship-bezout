...
\begin{proof}
  ...
  For compactness, we need to show that $\D_2(1, M)$ is tight (cf. Definition \ref{def:tight}) and closed. For tightness, we use Chebyshev's inequality. For any $\mu \in \D_2(1, M)$ and any $R > 0$
