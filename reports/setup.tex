...
% Chapter formatting for report/book classes
% Chapter formatting for report/book classes (no "Chapter N" label)
\titleformat{\chapter}[display]
{\normalfont\bfseries\centering\LARGE}
{}{5pt}{\LARGE}
\titlespacing*{\chapter}{0pt}{-10pt}{10pt}

% Starred (numberless) chapters should use the same visual style
% Starred (numberless) chapters use same visual style
\titleformat{name=\chapter,numberless}[display]
{\normalfont\bfseries\centering\Huge}{}{0pt}{\Huge}

% Keep section style as provided by the document class (restore default)
% (No custom \titleformat for \section so sections behave as before.)
...
% Define \myspace{n}: output n thin spaces (\,)
\makeatletter
\newcommand{\myspace}[1]{%
  \begingroup
  \@tempcnta=#1\relax
...
% Disable end statements in algorithms
